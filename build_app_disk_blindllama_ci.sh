...
./export_docker_image_as_targz.sh attestation-generator images/blindllama
...
./export_docker_image_as_targz.sh attestation-server:latest images/blindllama

earthly +k8s-tpm-device-plugin-image
./export_docker_image_as_targz.sh k8s-tpm-device-plugin-image images/blindllama
...
./export_docker_image_as_targz.sh nvidia-device-plugin:latest images/blindllama
